...
/**
 * Custom GatewayFilterFactory wired into Spring Cloud Gateway.
 *
 * With this class name, the filter is referenced in application.yml as:
 * - `JwtValidation`
 */
@Slf4j
@Component
    ...
    public GatewayFilter apply(Config config) {
        return (exchange, chain) -> {
            ...
            try {
                ...
                // They can use these as hints; they should still validate JWT independently.
